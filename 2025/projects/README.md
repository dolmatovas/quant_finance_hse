...
6. Deep-hedging
    ...
    Статья: https://arxiv.org/abs/1802.03042
    Ожидаемый результат:
...
12. Компактные схемы для вычисления цен американских опционов.
    Статьи:
    * [Compact finite difference method for American option pricing](https://www.sciencedirect.com/science/article/pii/S0377042706004511)
    Ожидаемый результат:
    * Реализация компактных схем для оценки стоимости европейских и американских опционов
    * Анализ утойчивости и сходимости схем
    * Сравнение границы экспирации для американских опционов с другими методами
